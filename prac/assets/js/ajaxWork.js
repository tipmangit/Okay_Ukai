...
function addItems(){
    ...
    fd.append('p_link', p_link);
    fd.append('file', file);
    fd.append('upload', true); // triggers the upload in PHP
...
function updateItems() {
    ...
    var p_name = $('#p_name').val();
    var p_price = $('#p_price').val();
    var p_link = $('#p_link').val(); // added link input
    ...
    fd.append('p_name', p_name);
    fd.append('p_price', p_price);
    fd.append('p_link', p_link); // added link field
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.trim() === "true") {
                ...
                alert('Failed to update. Server says: ' + data);
            }
        }
    });
