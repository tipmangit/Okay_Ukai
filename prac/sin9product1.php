...
<body>
    ...
    <section id="prodetails" class="section-p1">
        ...
        <img src="products3/ITEM 2-20231008T014537Z-001/ITEM 2/B2 ITEM 2 FRONT .jpg" width="100%" id="MainImg" alt="">
        
        <div class="small-img-group">
            <div class="small-img-col">
                <img src="products3/ITEM 2-20231008T014537Z-001/ITEM 2/B2 ITEM 2 FRONT .jpg" width="100%" class="small-img" alt="">
               </div>
               <div class="small-img-col">
                <img src="products3/ITEM 2-20231008T014537Z-001/ITEM 2/B2 ITEM 2 CLOSE UP .jpg" width="100%" class="small-img" alt="">
               </div>
               <div class="small-img-col">
                <img src="products3/ITEM 2-20231008T014537Z-001/ITEM 2/B2 ITEM 2 BACK .jpg" width="100%" class="small-img" alt="">
               </div>
            </div>
        </div>
        <div class="single-pro-details">
            <h6>Product Brand: Ancestress</h6>
            <h4>Track Sweater</h4>
            <h2>₱200</h2>
            <button class="normal add-cart" data-product-index="8">Add To Cart</button>
