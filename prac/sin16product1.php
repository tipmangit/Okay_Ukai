...
<body>
    ...
    <section id="prodetails" class="section-p1">
        ...
        <img src="products3/ITEM 3-20231008T014539Z-001/ITEM 3/B2 ITEM 3 FRONT.jpg" width="100%" id="MainImg" alt="">
        
        <div class="small-img-group">
            <div class="small-img-col">
                <img src="products3/ITEM 3-20231008T014539Z-001/ITEM 3/B2 ITEM 3 FRONT.jpg" width="100%" class="small-img" alt="">
               </div>
               <div class="small-img-col">
                <img src="products3/ITEM 3-20231008T014539Z-001/ITEM 3/B2 ITEM 3 CLOSE UP.jpg" width="100%" class="small-img" alt="">
               </div>
               <div class="small-img-col">
                <img src="products3/ITEM 3-20231008T014539Z-001/ITEM 3/B2 ITEM 3 BACK.jpg" width="100%" class="small-img" alt="">
               </div>
            </div>
        </div>
        <div class="single-pro-details">
            <h6>Product Brand: N/A</h6>
            <h4>Black Strap Crop Top</h4>
            <h2>₱50</h2>
            <button class="normal add-cart" data-product-index="15">Add To Cart</button>
