...
<body>
    ...
    <section id="prodetails" class="section-p1">
        ...
        <img src="products4/PANTS 2-20231008T022012Z-001/PANTS 2/PANTS 2 FRONT.jpg" width="100%" id="MainImg" alt="">
        
        <div class="small-img-group">
            <div class="small-img-col">
                <img src="products4/PANTS 2-20231008T022012Z-001/PANTS 2/PANTS 2 FRONT.jpg" width="100%" class="small-img" alt="">
               </div>
               <div class="small-img-col">
                <img src="products4/PANTS 2-20231008T022012Z-001/PANTS 2/PANTS 2 CLOSE UP .jpg" width="100%" class="small-img" alt="">
               </div>
               <div class="small-img-col">
                <img src="products4/PANTS 2-20231008T022012Z-001/PANTS 2/PANTS 2 BACK .jpg" width="100%" class="small-img" alt="">
               </div>
            </div>
        </div>
        <div class="single-pro-details">
            ...
            <h4>Blue Jeans</h4>
            <h2>₱300</h2>
            <button class="normal add-cart" data-product-index="9">Add To Cart</button>
            <h4>Product Details</h4>
            
            <span><b>Condition:</b> 10/10<br>
                <b>Issue/s:</b> none<br>
                <b>Waistline: </b> 32/33 <br>
                <b>Rise:</b> 10.5<br>
                <b>Inseam:</b> 27.5<br>
                <b>Thigh:</b> 10<br>
                <b>Knee Opening:</b> 9<br>
                <b>Leg Opening:</b> 7.5<br>
