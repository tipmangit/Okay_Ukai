...
<body>
    ...
    <section id="prodetails" class="section-p1">
        ...
        <img src="products4/ITEM 5-20231008T022005Z-001/ITEM 5/ITEM 5 FRONT final .jpg" width="100%" id="MainImg" alt="">
        
        <div class="small-img-group">
            <div class="small-img-col">
                <img src="products4/ITEM 5-20231008T022005Z-001/ITEM 5/ITEM 5 FRONT final .jpg" width="100%" class="small-img" alt="">
               </div>
               <div class="small-img-col">
                <img src="products4/ITEM 5-20231008T022005Z-001/ITEM 5/ITEM 5 CLOSE UP .jpg" width="100%" class="small-img" alt="">
               </div>
               <div class="small-img-col">
                <img src="products4/ITEM 5-20231008T022005Z-001/ITEM 5/ITEM 5 BACK-final .jpg" width="100%" class="small-img" alt="">
               </div>
            </div>
        </div>
        <div class="single-pro-details">
            <h6>Product Brand: Hollister</h6>
            <h4>Long Sleeve Striped Polo</h4>
            <h2>₱200</h2>
            <button class="normal add-cart" data-product-index="5">Add To Cart</button>
            ...
            <span><b>Condition:</b> 10/10<br>
                ...
                <b>Width:</b> 21.5<br>
                <b>Length:</b> 24.5<br>
                <b>Mine:</b> P200 + shipping<br>
                <b>Steal:</b> Add P20 to current price<br>
                <b>Grab:</b> P250 + shipping</span>
        </div>
    </section>
    ...
    <section id="product2" class="section-p1">
        ...
        <div class="pro-container2">
            <div class="pro">
                <img onclick="window.location.href='sin2product1.php';" src="productlist/ITEM 2 FRONT.jpg" alt="">
                <div class="des">
