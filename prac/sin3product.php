...
<body>
        ...
        <div class = "container">
            ...
            <div class="order-lg-2 nav-btns">
                            ...
                            <button type = "button" class = "btn position-relative" onclick = "location.href='cart.php'"><i class = "fa fa-shopping-cart"></i>
                                <span id="cart-item" class="position-absolute top-0 start-100 translate-middle badge bg-primary">0</span>
                            </button>
                            <button type="button" class="btn position-relative">
    ...
    <section id="prodetails" class="section-p1">
        ...
        <img src="products4/ITEM 4-20231008T022004Z-001/ITEM 4/ITEM 4 FRONT .jpg" width="100%" id="MainImg" alt="">
        
        <div class="small-img-group">
            <div class="small-img-col">
                <img src="products4/ITEM 4-20231008T022004Z-001/ITEM 4/ITEM 4 FRONT .jpg" width="100%" class="small-img" alt="">
               </div>
               <div class="small-img-col">
                <img src="products4/ITEM 4-20231008T022004Z-001/ITEM 4/ITEM 4 CLOSE UP .jpg" width="100%" class="small-img" alt="">
               </div>
               <div class="small-img-col">
                <img src="products4/ITEM 4-20231008T022004Z-001/ITEM 4/ITEM 4 BACK .jpg" width="100%" class="small-img" alt="">
               </div>
            </div>
        </div>
        <div class="single-pro-details">
            <h6>Product Brand: Main Street</h6>
            <h4>Short Sleeved Striped Polo</h4>
            <h2>₱120</h2>
