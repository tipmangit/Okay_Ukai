...
<body>
    ...
    <section id="prodetails" class="section-p1">
        ...
        <img src="products4/ITEM 6-20231008T022006Z-001/ITEM 6/ITEM 6 FRONT.jpg" width="100%" id="MainImg" alt="">
        
        <div class="small-img-group2">
            <div class="small-img-col2">
                <img src="products4/ITEM 6-20231008T022006Z-001/ITEM 6/ITEM 6 FRONT.jpg" width="100%" class="small-img" alt="">
               </div>
               <div class="small-img-col2">
                <img src="products4/ITEM 6-20231008T022006Z-001/ITEM 6/ITEM 6 CLOSE UP.jpg" width="100%" class="small-img" alt="">
               </div>
            <div class="small-img-col2">
                <img src="products4/ITEM 6-20231008T022006Z-001/ITEM 6/ITEM 6 BACK .jpg" width="100%" class="small-img" alt="">
               </div>
               <div class="small-img-col2">
                <img src="products4/ITEM 6-20231008T022006Z-001/ITEM 6/ITEM 6 ISSUE.jpg" width="100%" class="small-img" alt="">
               </div>
            </div>
        </div>
        <div class="single-pro-details">
            <h6>Product Brand: Hangten</h6>
            <h4>Striped Short Sleeve Polo</h4>
            <h2>₱120</h2>
            ...
            <span><b>Condition:</b> 7/10<br>
                <b>Issue/s:</b> slightly faded, slight discoloration<br>
                <b>Fitting estimate:</b> Small to Medium<br>
                <b>Width:</b> 20.5<br>
                <b>Length:</b> 27.5<br>
                <b>Mine:</b> P120 + shipping<br>
                <b>Steal:</b> Add P20 to current price<br>
                <b>Grab:</b> P140 + shipping</span>
        </div>
    </section>
